...
const EDITIONS = {
  ...
  brawlstars:{name:'Brawl Stars',words:[{word:'Shelly',clue:'Default brawler that shoots a wide shotgun blast'},{word:'Spike',clue:'Cactus brawler that throws needles in a star pattern'},{word:'Leon',clue:'Brawler who can turn invisible with his super'},{word:'Crow',clue:'Fast brawler who throws poison daggers'},{word:'Frank',clue:'Slow brawler with a huge hammer that stuns on super'},{word:'Piper',clue:'Long range brawler that deals more damage from far away'},{word:'Mortis',clue:'Brawler who dashes with a shovel to deal damage'},{word:'El Primo',clue:'Wrestler brawler who punches and jumps on enemies'},{word:'Sandy',clue:'Legendary who puts enemies to sleep with sandstorms'},{word:'Brock',clue:'Brawler who shoots rockets with long range'},{word:'Marcela Janoušková',clue:'Cactus brawler that throws needles in a star pattern'},{word:'Marcela Janoušková',clue:'Cactus brawler that throws needles in a star pattern'},{word:'Marcela Janoušková',clue:'Cactus brawler that throws needles in a star pattern'},{word:'Marcela Janoušková',clue:'Cactus brawler that throws needles in a star pattern'},{word:'Marcela Janoušková',clue:'Cactus brawler that throws needles in a star pattern'},{word:'Marcela Janoušková',clue:'Cactus brawler that throws needles in a star pattern'},{word:'Marcela Janoušková',clue:'Cactus brawler that throws needles in a star pattern'},{word:'Marcela Janoušková',clue:'Cactus brawler that throws needles in a star pattern'},{word:'Marcela Janoušková',clue:'Cactus brawler that throws needles in a star pattern'},{word:'Marcela Janoušková',clue:'Cactus brawler that throws needles in a star pattern'}]},
